                    ...
                    <table class="table table-hover mb-0 align-middle">
                        ...
                        <tbody>
                            @isset($barangs)
                                ...
                                <tr>
                                    <td><span class="fw-bold text-primary">#{{ $barang->kode_barang ?? 'BRG-'.$barang->id }}</span></td>
            ...
            <div class="card shadow-sm h-100">
                <div class="card-body">
                    ...
                    <div class="alert alert-info border-0 shadow-none mt-4">
                        ...
                        <small>Pastikan Anda sudah menambahkan <strong>Lokasi</strong> sebelum menginput barang baru agar relasi data terjaga.</small>
                    </div>
                </div>
            </div>
        </div>
...
@if (Session::has('alert.config') || Session::has('success') || Session::has('error'))
